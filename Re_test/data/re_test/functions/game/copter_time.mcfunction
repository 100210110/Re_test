...
execute if score copter time matches 600 run give @a[tag=gaming,scores={personal_difficulty=0..1}] tacz:modern_kinetic_gun{HideFlags:2,AttributeModifiers:[{Amount:50.0d,AttributeName:"minecraft:generic.armor",Operation:0,Slot:"mainhand",UUID:[I;0,1,2,3]},{Amount:30.0d,AttributeName:"minecraft:generic.armor_toughness",Operation:0,Slot:"mainhand",UUID:[I;4,5,6,7]},{Amount:100.0d,AttributeName:"minecraft:generic.knockback_resistance",Operation:0,Slot:"mainhand",UUID:[I;8,9,1,2]}],AttachmentEXTENDED_MAG:{id:"tacz:attachment",Count:1b,tag:{AttachmentId:"tacz:extended_mag_3"}},HasBulletInBarrel:1b,GunId:"zxgy:kits_t2",AttachmentSCOPE:{id:"tacz:attachment",Count:1b,tag:{AttachmentId:"tacz:sight_uh1"}},AttachmentMUZZLE:{id:"tacz:attachment",Count:1b,tag:{AttachmentId:"zxgy:kc"}},GunFireMode:"AUTO",GunCurrentAmmoCount:10000000,AttachmentGRIP:{id:"tacz:attachment",Count:1b,tag:{AttachmentId:"zxgy:cqbmk"}},AttachmentSTOCK:{id:"tacz:attachment",Count:1b,tag:{AttachmentId:"tacz:stock_militech_b5"}}}
execute if score copter time matches 600 run give @a[tag=gaming,scores={personal_difficulty=0..1}] tacz:modern_kinetic_gun{AttachmentEXTENDED_MAG: {id: "tacz:attachment", Count: 1b, tag: {AttachmentId: "tacz:extended_mag_3"}}, HasBulletInBarrel: 1b, GunId: "tacz:aa12", AttachmentSCOPE: {id: "tacz:attachment", Count: 1b, tag: {AttachmentId: "tacz:sight_uh1"}}, GunFireMode: "AUTO", GunCurrentAmmoCount: 100000000, AttachmentGRIP: {id: "tacz:attachment", Count: 1b, tag: {AttachmentId: "tacz:grip_magpul_afg_2"}}}
