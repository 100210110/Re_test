...
execute unless entity @a[team=score.life] run tellraw @a [{"text":""},{"text":"- ","color":"green"},{"text":"无人生还","color":"gray"}]
...
execute unless entity @a[team=score.dead] run tellraw @a [{"text":""},{"text":"- ","color":"green"},{"text":"全员生还","color":"aqua"}]
