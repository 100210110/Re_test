# 运行此函数将 单场的存活时间 改为 时分秒格式
execute store result score @s time.life_time_s run scoreboard players get @s time.dead_life
execute store result score @s time.life_time_m run scoreboard players get @s time.dead_life
execute store result score @s time.life_time_h run scoreboard players get @s time.dead_life
