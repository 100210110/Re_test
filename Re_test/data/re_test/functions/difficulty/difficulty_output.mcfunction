...
# Moi的风格
execute if score @s personal_difficulty matches 0 run tellraw @a[scores={difficulty_style=1}] [{"text":""},{"selector":"@s","color":"green"},{"text":" 的难度为: ","bold":true,"color":"yellow"},{"text":">80岁老奶奶坐轮椅模式<","bold":true,"color":"#66CCFF"}]
execute if score @s personal_difficulty matches 1 run tellraw @a[scores={difficulty_style=1}] [{"text":""},{"selector":"@s","color":"green"},{"text":" 的难度为: ","bold":true,"color":"yellow"},{"text":">8岁小宝宝坐婴儿车模式<","bold":true,"color":"green"}]
execute if score @s personal_difficulty matches 2 run tellraw @a[scores={difficulty_style=1}] [{"text":""},{"selector":"@s","color":"green"},{"text":" 的难度为: ","bold":true,"color":"yellow"},{"text":">20岁纯情男大の普通模式<","bold":true,"color":"yellow"}]
execute if score @s personal_difficulty matches 3 run tellraw @a[scores={difficulty_style=1}] [{"text":""},{"selector":"@s","color":"green"},{"text":" 的难度为: ","bold":true,"color":"yellow"},{"text":">28岁大哥副业小曲の困难模式<","bold":true,"color":"red"}]
execute if score @s personal_difficulty matches 4 run tellraw @a[scores={difficulty_style=1}] [{"text":""},{"selector":"@s","color":"green"},{"text":" 的难度为: ","bold":true,"color":"yellow"},{"text":">18岁Moiの地狱模式<","bold":true,"color":"dark_red"}]
# 明日方舟
