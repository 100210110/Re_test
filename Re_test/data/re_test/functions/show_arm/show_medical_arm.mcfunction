execute if score show_medical_mark mode matches 1 run scoreboard players set show_medical_mark mode 2
execute if score show_medical_mark mode matches 0 run scoreboard players set show_medical_mark mode 1
execute if score show_medical_mark mode matches 2 run scoreboard players set show_medical_mark mode 0
